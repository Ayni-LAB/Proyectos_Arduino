...
Servo Base; // Crear un objeto tipo Servo llamado Base
Servo Horizontal; // Crear un objeto tipo Servo llamado Horizontal
Servo Vertical; // Crear un objeto tipo Servo llamado Vertical
Servo Pinza; // Crear un objeto tipo Servo llamado Pinza
